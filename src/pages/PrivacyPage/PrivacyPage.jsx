...
const SECTIONS = [
  {
    title: "1. מבוא והיקף",
    content: [
      "מדיניות פרטיות זו מתארת כיצד IN-CHECK, בבעלות לירן לוי, אוספת, משתמשת, שומרת, משתפת ומגנה על מידע אישי של מבקרי האתר https://www.checkin-levy.com ושל פונים אלינו באמצעי תקשורת אחרים.",
  ...
  },
  {
    ...
    content: [
      "הבקר על המידע הוא IN-CHECK, בבעלות לירן לוי.",
      "דומיין ראשי: https://www.checkin-levy.com",
    ],
    contact: [
      {
        label: 'דוא"ל',
        value: "otaCheckin24@gmail.com",
        href: "mailto:otaCheckin24@gmail.com",
      },
  ...
  },
  {
    ...
    items: [
      "שליחת מייל לכתובת otaCheckin24@gmail.com",
  ...
  },
  {
    ...
    content: [
      'לגבי מידע של לקוחות, מתעניינים ומבקרי האתר, IN-CHECK פועלת כ"בקר מידע" ומחליטה על מטרות ואמצעי העיבוד.',
  ...
  },
  {
    ...
    items: [
      "אתר React (IN-CHECK) — טפסי יצירת קשר, הצגת תוכן ותפעול האתר",
        ...
        <header className="privacy-hero">
          <div className="privacy-hero-inner">
            ...
            <p className="privacy-subtitle">
              IN-CHECK מחויבת להגנה על פרטיותך. מדיניות זו מסבירה כיצד אנו
