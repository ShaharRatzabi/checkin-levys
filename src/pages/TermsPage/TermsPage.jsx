...
const SECTIONS = [
  {
    ...
    content: [
      'אתר האינטרנט https://www.checkin-levys.com (להלן: "האתר") מופעל על ידי Check-In, בבעלות לירן לוי (להלן: "החברה").',
        ...
        <header className="terms-hero">
          <div className="terms-hero-inner">
            ...
            <p className="terms-subtitle">
              תקנון שימוש באתר, תנאי שירות והגבלת אחריות — Check-In, בבעלות לירן
